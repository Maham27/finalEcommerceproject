...
public class address extends AppCompatActivity implements adressadptor.clickedadess{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Object o=getIntent().getSerializableExtra("item");
        ...
        btnp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    products newproducts=(products) o;
                    amount=newproducts.getPrice();
                }
                if(o instanceof  allproducts)
                {
                    allproducts allproducts=(allproducts) o;
                    amount=allproducts.getP();
                }
                Intent i=new Intent(address.this,payment.class);
